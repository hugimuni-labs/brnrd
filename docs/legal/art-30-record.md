...
4. **Review scope**: This record reflects the code state as of 2026-07-24 (commit aaca33d6), updated 2026-07-25 for the Art 17 self-service deletion mechanism (note 1), and updated 2026-07-31 for the hosting sub-processor change (note 5). Code changes affecting retention times, recipients, or data flows should trigger a review and update of this record.
