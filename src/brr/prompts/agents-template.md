...
<!-- What this project is, what stack it uses, what it does. One paragraph. -->

## Build and run

<!-- Exact commands to install dependencies, build, test, and run. Use code blocks. -->

## Code guidelines

<!-- Language version, formatting tools, test framework, commit message style. Be specific to what's in the repo. -->
...
<!-- Project-specific constraints: sensitive directories, deployment -->
<!-- commands, public API surfaces, payment/auth code — anything an -->
<!-- agent should not change without explicit approval. -->
