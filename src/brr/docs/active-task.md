...
Every daemon wake ships a `Run Context Bundle` near the top of
...
- A generated run context file under `.brr/runs/<run-id>/context.md`
...
The run context file is generated for the current run and lives in the
